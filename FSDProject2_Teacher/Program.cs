...
namespace FSDProject_Teacher
{
    ...
    public class School : Teacher
    {
        ...
        public string path = @"C:\FSD\Phase1_FSD_DotNetProject\FSDProject2_Teacher\TeacherRecord.txt";
        ...
        public void displaymenu()
        {
            //Main Menu 
            Console.WriteLine("=====================================================");
            Console.WriteLine(" FSD Phase 01 Project - Rainbow SCHOOL ");
            Console.WriteLine("=====================================================");
        ...
        public void Addrecord()
        {
            try
            {
                ...
                foreach (Teacher Tech in TTeach001)
                {
                    ...
                    Console.WriteLine("\n\nAdd Teacher Record updated Succesfully");
                }
                sw.Close();
            }
            catch (Exception e)
        ...
        public void updateParticularRecord(String TID, String RecordFeild, String Oldvalue, String Newvalue)
        {
            try
            {
                ...
                if (msg.Contains(TID))
                {
                    ...
                    Console.WriteLine("The Row has been edited successfully: " + TID + "\n Feild Updated :" + RecordFeild + "\n Old Value :" + Oldvalue + "\n Newvalue :" + Newvalue);
                }
                else
                {
